# -*- coding: utf-8 -*-
"""
Created on Thur October 17 10:23:00 2019
...
folderPath = '..\\..\\Crowding_and_numerosity\\MatchingAlgorithm\\Idea2\\Stimuli20191017\\InputRawStimuli\\'
dic_files = {(0.7,1):folderPath +'idea2_crwdng1_ws_0.7.csv',
             (0.7,0):folderPath +'idea2_crwdng0_ws_0.7.csv',
             (0.6,1):folderPath +'idea2_crwdng1_ws_0.6.csv',
             (0.6,0):folderPath +'idea2_crwdng0_ws_0.6.csv',
             (0.5,1):folderPath +'idea2_crwdng1_ws_0.5.csv',
             (0.5,0):folderPath +'idea2_crwdng0_ws_0.5.csv',
             (0.4,1):folderPath +'idea2_crwdng1_ws_0.4.csv',
             (0.4,0):folderPath +'idea2_crwdng0_ws_0.4.csv',
             (0.3,1):folderPath +'idea2_crwdng1_ws_0.3.csv',
             (0.3,0):folderPath +'idea2_crwdng0_ws_0.3.csv'}
...
# read csv to df
# =============================================================================
stimuliInfo_df=pd.read_csv(my_choice,header = None,error_bad_lines=False) #this will cause offending lines to be skiped
...
name_list[1] = 'N_disk'
name_list[2] = 'N_ellipseCross'
name_list[3] = 'extraDisk'
name_list[4] = 'positions'
name_list[5] = 'convexHull'
name_list[6] = 'averageE'
name_list[7] = 'avg_spacing'
name_list[8] = 'occupancyArea'
...
writer = pd.ExcelWriter(folderOutputPath+'Idea2_allStimuliInfo_ws%s_crwdng%s.xlsx' %(ws, crowdingDis),engine='xlsxwriter')
...
stimuliInfo_pivotT.to_excel(folderOutputPath+'Idea2_pivotT_ws%s_crwdng%s.xlsx' %(ws, crowdingDis))
