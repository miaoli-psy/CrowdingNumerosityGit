...
import idea2_direcMani_largeWinsize
...
# =============================================================================
start = time.time()
multiParaFunc = partial(idea2_direcMani_largeWinsize.runStimuliGeneration, newWindowSize, drawEllipseFig, ellipse_ka, ellipse_kb) 
