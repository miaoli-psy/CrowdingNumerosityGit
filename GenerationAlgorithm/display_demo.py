...
exp1_no_crowding = [(-240.0, -190.0), (-90.0, -130.0), (-270.0, -90.0), (-50.0, -210.0), (210.0, 170.0), (-300.0, 190.0), (300.0, -190.0), (-40.0, 160.0), (60.0, -140.0), (120.0, 50.0), (-260.0, 10.0), (250.0, -30.0), (300.0, 130.0), (140.0, -80.0), (30.0, 190.0), (100.0, 170.0), (190.0, 30.0), (120.0, -120.0), (-180.0, 80.0), (20.0, -190.0), (-40.0, -100.0), (-110.0, -50.0), (180.0, -210.0), (260.0, -90.0), (-270.0, 70.0), (70.0, 100.0), (-190.0, 170.0), (120.0, 120.0), (-80.0, 70.0), (80.0, -60.0), (-110.0, -80.0), (-180.0, -20.0), (150.0, -10.0), (-10.0, 120.0), (30.0, 100.0), (-180.0, -220.0), (-60.0, 100.0), (-130.0, 180.0), (-10.0, 220.0), (-140.0, 10.0), (20.0, -100.0), (-110.0, -20.0), (130.0, -40.0), (-10.0, -130.0), (-90.0, 50.0), (60.0, -90.0), (-100.0, 30.0), (-110.0, -220.0), (120.0, -220.0), (100.0, 20.0), (-90.0, 210.0), (-180.0, -100.0), (100.0, 70.0)]
# =============================================================================
# draw ellipse
# =============================================================================
...
def drawEllipses(posi, ka, kb, ellipseColor = 'orangered', ellipsetransp = 0.5):
...
def drawEllipse_crowding(e_posi, crowding_posi, ka, kb,ellipseColor_r = 'orangered', ellipseColor_t = 'lime'):
        """
        ...
        my_e = [Ellipse(xy=crowding_posi[j], width=eccentricities_c[j]*ka*2, height=eccentricities_c[j]*kb*2, angle = angle_deg_c[j])
...
drawEllipse_crowding(exp1_crowding,crowded_posi, ka=0.25, kb=0.1, ellipseColor_r = 'orangered', ellipseColor_t = 'lime')